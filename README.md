...
點擊[此處](https://github.com/Arthurmcarthur/Cangjie3-Plus/releases/download/4.2/RimeData_20251014_Cangjie3_WithExtJ.7z)下載適用於Rime的方案文件。

點擊[此處](https://github.com/Arthurmcarthur/Cangjie3-Plus/releases/download/4.3/MSCJData_20260908_Cangjie3_WithExtJ.7z)下載適用於替換微軟倉頡碼表的文件。<del>（使用說明見[此處](http://www.chinesecj.com/forum/forum.php?mod=viewthread&tid=194346)）</del>
...
收錄了筆畫、部首、部首增補區、漢字兼容區、兼容區增補中的字符，以及表意文字描述符號。
